...
router.post("/order", async (req, res) => {
  ...
  try {
    ...
    const bookingData = {
      ...
      total_amount: Number(total_amount), // Ensure number type
      Payment_Mode: "PENDING", // Initial value, updated after payment
      favoriteEmployee,
    ...
    const options = {
      amount: Math.round(amount * 100), // Amount in paise (amount paid)
      currency: "INR",
